...
<Dialog
	...
	show={show}
	class="p-0 h-screen w-screen md:max-w-fit md:max-h-fit"
>
	<DialogHeader
			slot="header"
	...
	>
		<div class="flex flex-col justify-center cursor-default gap-5">
			...
			<input
				class="w-full rounded-lg py-2 px-4 text-sm bg-gray-100 dark:text-gray-300 dark:bg-gray-850 outline-hidden text-blue-800 placeholder:text-gray-400"
				bind:value={name}
				type="text"
				required
		...
		<div class="flex flex-col justify-center cursor-default gap-5">
			...
			<textarea
				class="w-full resize-none rounded-lg py-2 px-4 text-sm bg-gray-100 text-blue-800 placeholder:text-gray-400 dark:text-gray-300 dark:bg-gray-850 outline-hidden"
