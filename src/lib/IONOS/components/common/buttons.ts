...
const stateMap = {
	'primary': {
		'all': 'border-2 outline-offset-4 rounded-full font-semibold',
	...
	'tertiary': {
		'all': 'border-2 border-transparent text-blue-700 outline-offset-4 rounded-full font-semibold',
	...
	'caution': {
		'all': 'border-2 border-white text-red-500 rounded-full font-semibold',
	...
	'special': {
		'all': 'border-2 bg-purple-700 border-purple-700 text-white rounded-full font-semibold',
		'stateless': 'outline-offset-4',
