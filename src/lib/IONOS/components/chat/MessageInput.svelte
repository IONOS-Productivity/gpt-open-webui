						...
						>
							<div class="flex flex-col">
								<textarea
									...
									class="scrollbar-hidden bg-transparent text-blue-700 placeholde:text-gray-400 dark:text-gray-100 outline-none w-full py-3 px-4 rounded-xl resize-none h-[48px]"
