...
<Modal size="xl" bind:show>
	<div>
		...
		<div class="flex flex-col w-full px-5 pb-5 dark:text-gray-200">
			<div
				class=" flex flex-col w-full sm:flex-row sm:justify-center sm:space-x-6 h-[28rem] max-h-screen outline rounded-xl outline-gray-100 dark:outline-gray-800 mb-4 mt-1"
			>
			...
			<div class="flex text-sm font-medium gap-1.5">
				...
				>
				<button
					class=" px-3.5 py-1.5 font-medium text-red-500 hover:bg-black/5 dark:hover:bg-white/5 outline outline-red-300 dark:outline-red-800 rounded-3xl"
					on:click={() => {
						if (memories.length > 0) {
