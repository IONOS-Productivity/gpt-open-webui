...
>
	...
	<slot name="content">
		...
		>
			...
			<a
				class="flex rounded-md p-2.5 w-full text-blue-800 hover:bg-gray-200 dark:hover:bg-gray-800 transition" href="https://www.ionos.de/hilfe/index.php?id=25241" target="_blank" rel="noopener noreferrer"
				>
				<div class=" self-center mr-3">
					<LifeRing />
				</div>
