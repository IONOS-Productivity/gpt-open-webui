...
Create a concise, 3-5 word title as a title for the chat history.

### Guidelines:
- Write the title in the user's primary language.
- Avoid quotation marks, emojis or special formatting.
